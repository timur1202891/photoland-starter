...
const Hero = () => {
  return (
    <section className='mb-[3-px] pt-36 lg:pt-0'>
        ...
        <div className='flex flex-col gap-y-[30px] xl:flex-row xl:gap-x-[30px]'>
          ...
          <div className='flex flex-col gap-y-[30px] w-full max-w-lg mx-auto h-[500px]'>
            <div className='grad flex-1 h-[250px] rounded-[8px] overflow-hidden relative p-6'>
              ...
              <img className='z-20 absolute -top-2 -right-4' src={PromoImg1} alt='' />
            </div>
            <div className='grad flex-1 h-[250px] rounded-[8px] overflow-hidden relative p-6'>
              <div className='flex flex-col max-w-[144px] h-full justify-center'>
                <div className='text-[20px] uppercase font-medium leading-tight mb-4'>
              ...
              <img className='z-20 absolute top-4 -right-6' src={PromoImg2} alt='' />
            </div>
          </div>
        </div>
      </div>
